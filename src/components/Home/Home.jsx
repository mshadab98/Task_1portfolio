       ...
       {/* // left section  */}
        ...
        <div className='container mx-auto max-w-screen-lg  flex flex-col-reverse md:flex-row items-center  px-8 md:px-16 '>
           <div className=" md:w-1/2 text-center md:text-left space-y-4 ">
            ...
            <button className="mt-4 px-6 py-3 m-2 bg-teal-500 hover:bg-teal-600 text-white font-bold rounded-lg shadow-md transition">
              Hire Me
            </button>
           <button className="mt-4 px-6 py-3 m-2 bg-teal-500 hover:bg-teal-600 text-white font-bold rounded-lg shadow-md transition">
            <a href="https://github.com/mshadab98">
            Github Repo</a>
            </button> 
           </div>
           ...
           <div className="md:w-1/2 flex justify-center">
            <img className='w-60 md:w-80  rounded-full border-4 border-teal-400 shadow-lg' src={ProfilePic} alt="" />
           </div>
        </div>
    </section>
